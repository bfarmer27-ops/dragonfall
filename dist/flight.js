...
export const SPEED_MULTIPLIER_MIN=1,SPEED_MULTIPLIER_MAX=3.5;
...
export function stepFlight(f,left,right,dt){
 ...
 f.vy=damp(f.vy,dive?NOSE_DIVE_SINK:(command.pitch*16-.65)*VERTICAL_SPEED_MULTIPLIER,dive?3:2.4,dt);
